...
nValid  = 0;
while nValid < nWant && iLoop < 1e6*2 %%NEEDFIX: the plane may not be wide enough to support points s.t R > radius(disk) where numdisks >= 180 per plane (not enough space for disks that do not overlap.)

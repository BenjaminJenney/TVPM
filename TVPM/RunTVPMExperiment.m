...
ds.experimentType = condition; % 'real', 'simulated', 'stabilized', 'tvpmsd', 'tvpmmask'
            ...
            if (MONOCULAR && renderPass == 0) || (~MONOCULAR)
                ...
                if ds.vbl <  pa.trialOnset + pa.targetMotionDuration % if current time < present until time: draw target, 1 s target motion
                    ...
                    if ds.simulated
                        ...
                        gluLookAt(-xDotDisplacementTraining,0,-zDotDisplacementTraining,0,0,-pa.cubeWidth/4,0,1,0);
                        ...
                        moglDrawDots3D(ds.w, [0 0 -pa.cubeWidth 1]', 3*2, pa.red, [], 2); %drawing fixation dot in environ % CSB june 21 2021 uncomment
                    elseif ds.real
                        glPushMatrix;
